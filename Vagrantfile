...
#Configure a forwarded port to access eAPI on vEOS
 #https://username:password@localhost:8443/command-api
   leaf1a.vm.network "forwarded_port", guest: 8443, host: 8443
    end
...
#Configure a forwarded port to access eAPI on vEOS
 #https://username:password@localhost:8443/command-api
   leaf1b.vm.network "forwarded_port", guest: 8443, host: 8444
    end
...
#Configure a forwarded port to access eAPI on vEOS
 #https://username:password@localhost:8443/command-api
   leaf2a.vm.network "forwarded_port", guest: 8443, host: 8445
    end
...
#Configure a forwarded port to access eAPI on vEOS
 #https://username:password@localhost:8443/command-api
   leaf2b.vm.network "forwarded_port", guest: 8443, host: 8446
    end
 ...
 #https://username:password@localhost:8445/command-api
      spine1.vm.network "forwarded_port", guest: 8445, host: 8447
    end

  # config.vm.provision :shell do |spine2|
  # spine2.path = 'switchserials/setupspine2.sh'
   # end
 ...
 #https://username:password@localhost:8446/command-api
      spine2.vm.network "forwarded_port", guest: 8446, host: 8448
    end
